...
/* Command-line: gperf -C -E -m -f --output-file=src/instructions.c src/instructions.gperf  */
  ...
  static const unsigned char asso_values[] =
    {
      ...
      31, 31, 31, 31, 31, 31, 31, 31, 31, 31,
      31, 31, 31, 31, 31, 31, 31, 31, 31, 31,
      31, 31, 31, 31, 31, 31,  0,  0, 25,  0,
       5,  0,  5, 15, 31, 31,  0, 20,  0, 31,
       0, 31,  5,  0, 10, 15, 31,  0,  5,  0,
      31, 31, 31, 31, 31, 31, 31, 31, 31, 31,
      31, 31, 31, 31, 31, 31, 31, 31, 31, 31,
      31, 31, 31, 31, 31, 31, 31, 31, 31, 31,
      31, 31, 31, 31, 31, 31, 31, 31, 31, 31,
...
#line 32 "src/instructions.gperf"
      {"SAY", CMD_SAY, 2, true},
#line 42 "src/instructions.gperf"
...
#line 38 "src/instructions.gperf"
      ...
      {""},
#line 43 "src/instructions.gperf"
      {"END", CMD_END, 0, false},
